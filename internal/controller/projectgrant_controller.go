...
func (r *ProjectGrantReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	var cr zitadelv1alpha1.ProjectGrant
	...
	if !cr.DeletionTimestamp.IsZero() {
		// TODO: Delete project grant from Zitadel.
	...
	// TODO: Implement project grant creation/sync with Zitadel API.
	logger.Info("projectgrant reconcile not yet implemented",
		"projectRef", cr.Spec.ProjectRef,
		"grantedOrgId", cr.Spec.GrantedOrgId)
	...
	cr.Status.Conditions = []metav1.Condition{
		{
			...
			Message:            fmt.Sprintf("ProjectGrant reconciliation not yet implemented for project %q", cr.Spec.ProjectRef),
